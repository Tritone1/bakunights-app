...
export type Deal = {
  ...
  offerMenuItems?: { menuItemId: string; overridePriceAzn?: string | number | null; menuItem: { id: string; name: string; photoUrl?: string | null; priceAzn: string | number; category?: { name: string } } }[];
