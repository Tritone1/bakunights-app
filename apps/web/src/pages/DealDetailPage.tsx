...
export function DealDetailPage() {
  ...
  async function submitFeedback() {
    ...
    setBusy("feedback");
    try { await api(`/deals/${deal.id}/feedback`, { method: "POST", body: JSON.stringify({ wasHonored: feedbackChoice, comment: feedbackChoice ? null : feedbackComment || null }) }); setNotice("Thanks. Your response helps keep BakuNights trustworthy."); await load(); }
