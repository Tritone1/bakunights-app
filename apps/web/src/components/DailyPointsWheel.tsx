  ...
  return <section className="border-y border-white/[0.07] bg-[#0d0d15] px-5 py-16 sm:px-8">
    <div className="mx-auto grid max-w-[1200px] items-center gap-10 lg:grid-cols-[minmax(320px,480px)_1fr]">
      <div>
        ...
        <p className="mt-4 max-w-xl text-sm leading-6 text-white/55">Visit a participating venue and show your in-app QR code. When the merchant verifies your visit, one spin unlocks. Small wins appear more often, while high prizes are strictly limited.</p>
        <div className="mt-5 flex flex-wrap gap-2 text-[10px] font-black uppercase tracking-[.14em]"><span className="rounded-full border border-cyan-300/25 bg-cyan-300/10 px-3 py-1.5 text-cyan-200">24 prize slices</span><span className="rounded-full border border-orange-300/25 bg-orange-300/10 px-3 py-1.5 text-orange-200">50 points · 2%</span><span className="rounded-full border border-gold/25 bg-gold/10 px-3 py-1.5 text-amber-200">60 points · 1%</span><span className="rounded-full border border-emerald-300/25 bg-emerald-300/10 px-3 py-1.5 text-emerald-200">Verified visits only</span></div>
