...
const messages: Record<string, Translation> = {
  ...
  "In Google Maps, choose Rides and select Bolt. Google will pass the pickup and destination to Bolt.": ["Google Maps-də Taksi bölməsini, sonra Bolt-u seç. Google başlanğıc və təyinat nöqtəsini Bolt-a ötürəcək.", "В Google Maps выберите «Поездки», затем Bolt. Google передаст в Bolt место посадки и пункт назначения."],
